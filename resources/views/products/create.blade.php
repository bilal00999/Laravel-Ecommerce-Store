...
<div class="container-fluid" style="max-width: 900px; margin: 0 auto; padding: 2rem 1rem;">
    ...
    <!-- Permission Check -->
    @unless (auth()->user() && (auth()->user()->is_admin || auth()->user()->role === 'admin'))
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="alert alert-info">
                            <h6 class="alert-heading"><i class="bi bi-info-circle"></i> Product Info</h6>
                            <small>Fill in all required fields marked with <span class="text-danger">*</span> to create a new product.</small>
                        </div>
                    </div>
                </div>
