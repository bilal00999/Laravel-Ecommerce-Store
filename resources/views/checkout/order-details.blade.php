...
<div class="container mt-4">
    <div class="row mb-4">
        <div class="col-md-12">
            <a href="{{ route('checkout.orders') }}" class="btn btn-outline-secondary btn-sm">
                <i class="bi bi-arrow-left"></i> Back to Orders
            </a>
            <h2 class="mt-2"><i class="bi bi-file-text"></i> Order #{{ str_pad($order->id, 8, '0', STR_PAD_LEFT) }}</h2>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-md-8">
            ...
            <div class="card mb-4">
                <div class="card-header text-white" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);">
                    <h5 class="mb-0"><i class="bi bi-bag"></i> Order Items ({{ $items->count() }})</h5>
                </div>
                <div class="card-body">
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center gap-3">
                                                ...
                                                <div>
                                                    ...
                                                    <small class="text-muted">SKU: #{{ str_pad($item->product->id, 5, '0', STR_PAD_LEFT) }}</small>
                                                </div>
                                            </div>
                                        </td>
    ...
    <div class="row mt-4">
        <div class="col-md-12">
            <a href="{{ route('checkout.orders') }}" class="btn text-white" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); border: none;">
                <i class="bi bi-arrow-left"></i> Back to Orders
            </a>
