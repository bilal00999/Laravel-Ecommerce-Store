                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->guard()->check()): ?>
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                <li><a class="dropdown-item" href="<?php echo e(route('checkout.orders')); ?>">
                                    <i class="bi bi-file-text"></i> My Orders
                                </a></li>
                                <li><a class="dropdown-item" href="<?php echo e(route('contact.history')); ?>">
...
<?php /**PATH C:\laragon\www\ecommerce_store\resources\views/layouts/app.blade.php ENDPATH**/ ?>