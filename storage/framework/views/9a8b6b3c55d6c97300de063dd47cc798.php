...
<div class="product-detail-bg">
    <div class="container">
        ...
        <nav>
            <ol class="breadcrumb breadcrumb-custom">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($product->category): ?>
                    <li><a href="<?php echo e(route('products.index', ['category' => $product->category->id])); ?>"><?php echo e($product->category->name); ?></a></li>
                ...
                <div class="product-details">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($product->category): ?>
                        <div class="category-badge">
                            <i class="bi bi-tag"></i> <?php echo e($product->category->name); ?>
                    ...
                    <div class="product-meta">
                        <div class="meta-item">
                            ...
                            <span>By <strong><?php echo e($product->user->name); ?></strong></span>
                        </div>
                        <div class="meta-item">
                            <i class="bi bi-clock-history"></i>
                            <span><?php echo e($product->created_at->diffForHumans()); ?></span>
                        </div>
                    </div>
                    ...
                    <div class="price-box">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($product->stock > 0): ?>
                            <span class="stock-badge"><i class="bi bi-check-circle"></i> In Stock - <?php echo e($product->stock); ?> available</span>
                        <?php else: ?>
                    ...
                    <div class="action-buttons">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($product->stock > 0): ?>
                            <form action="<?php echo e(route('cart.add', $product)); ?>" method="POST" style="width: 100%; max-width: 300px;">
                                <?php echo csrf_field(); ?>
                        ...
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        <a href="<?php echo e(route('products.index')); ?>" class="btn-back">
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('update', $product)): ?>
                        <div style="margin-top: 1rem; display: flex; gap: 1rem; flex-wrap: wrap;">
                            <a href="<?php echo e(route('products.edit-image', $product)); ?>" style="padding: 0.5rem 1rem; background: #2196F3; color: white; border-radius: 6px; text-decoration: none; font-weight: 600;">
        ...
        <div style="background: white; padding: 3rem; border-radius: 15px; box-shadow: 0 5px 20px rgba(0,0,0,0.08); margin-bottom: 3rem;">
            ...
            <p style="font-size: 1.1rem; line-height: 1.8; color: #666;"><?php echo e($product->description); ?></p>

            <div class="info-grid">
                <div class="info-item">
                    <div class="info-label">Product ID</div>
                    <div class="info-value">#<?php echo e($product->id); ?></div>
                </div>
                <div class="info-item">
                    <div class="info-label">SKU</div>
                    <div class="info-value"><?php echo e($product->slug); ?></div>
                </div>
                <div class="info-item">
                    <div class="info-label">Stock</div>
                    <div class="info-value"><?php echo e($product->stock); ?> units</div>
                </div>
                <div class="info-item">
                    <div class="info-label">Last Updated</div>
                    <div class="info-value"><?php echo e($product->updated_at->format('M d, Y')); ?></div>
                </div>
            </div>
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin')): ?>
                <div class="admin-box">
                    ...
                    <p><strong>Creator ID:</strong> <?php echo e($product->user_id); ?></p>
                    <p><strong>Category ID:</strong> <?php echo e($product->category_id ?? 'None'); ?></p>
                    <p><strong>Created:</strong> <?php echo e($product->created_at->format('M d, Y H:i')); ?></p>
                </div>
            <?php endif; ?>

            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete', $product)): ?>
                <div style="margin-top: 1rem; display: flex; gap: 1rem;">
                    <a href="<?php echo e(route('products.edit', $product)); ?>" style="padding: 0.5rem 1rem; background: #ff9800; color: white; border-radius: 6px; text-decoration: none; font-weight: 600;">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $relatedProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $related): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <div class="related-card">
                            <div class="related-image">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($related->image_path && file_exists(public_path($related->image_path))): ?>
                                    <img src="<?php echo e(asset($related->image_path)); ?>" alt="<?php echo e($related->name); ?>" style="width: 100%; height: 100%; object-fit: cover;">
                                <?php else: ?>
                            ...
                            <div class="related-body">
                                <div style="font-weight: 700; color: #333; margin-bottom: 0.5rem;">
                                    <a href="<?php echo e(route('products.show', $related)); ?>" style="color: inherit; text-decoration: none;">
                                        <?php echo e(Str::limit($related->name, 40)); ?>

                                    </a>
                                </div>
                                <p style="color: #999; font-size: 0.9rem; margin: 0.5rem 0;"><?php echo e(Str::limit($related->description, 60)); ?></p>
                                <div style="display: flex; justify-content: space-between; align-items: center; margin-top: 1rem;">
                                    <div class="related-price">$<?php echo e(number_format($related->price, 2)); ?></div>
                                    <span style="background: #667eea; color: white; padding: 0.3rem 0.7rem; border-radius: 20px; font-size: 0.85rem;"><?php echo e($related->stock); ?> stock</span>
                                </div>
                                <a href="<?php echo e(route('products.show', $related)); ?>" style="display: block; margin-top: 1rem; text-align: center; color: white; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); padding: 0.7rem; border-radius: 6px; text-decoration: none; font-weight: 600; transition: all 0.3s ease;" onmouseover="this.style.transform='translateY(-2px)'; this.style.boxShadow='0 5px 15px rgba(102, 126, 234, 0.3)';" onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='none';">
                                    View Details
                                </a>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\ecommerce_store\resources\views/products/show.blade.php ENDPATH**/ ?>