    ...
    <div class="container-lg py-5">
        ...
        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 3rem;">
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create', App\Models\Product::class)): ?>
                <a href="<?php echo e(route('products.create')); ?>" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; padding: 0.8rem 1.8rem; border-radius: 8px; text-decoration: none; font-weight: 600; display: inline-flex; align-items: center; gap: 0.5rem; box-shadow: 0 4px 12px rgba(102, 126, 234, 0.3); transition: all 0.3s ease;">
        ...
        <div class="search-section">
            <form action="<?php echo e(route('products.index')); ?>" method="GET" style="display: flex; gap: 1rem; flex-wrap: wrap;">
                <div style="flex: 1; min-width: 250px;">
                    <input type="text" name="search" class="form-control search-input" placeholder="🔍 Search for products..." value="<?php echo e($search); ?>" style="border: 2px solid #667eea; border-radius: 25px; padding: 0.75rem 1.5rem; font-size: 1rem;">
                </div>
        ...
        <div style="display: flex; gap: 2rem; margin-top: 2rem;">
                    ...
                    <form action="<?php echo e(route('products.index')); ?>" method="GET">
                        <div class="filter-card">
                            ...
                            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 0.75rem;">
                                <input type="number" name="min_price" class="form-control" placeholder="Min" value="<?php echo e($minPrice); ?>" step="0.01" style="border-radius: 6px;">
                                <input type="number" name="max_price" class="form-control" placeholder="Max" value="<?php echo e($maxPrice); ?>" step="0.01" style="border-radius: 6px;">
                            </div>
                        ...
                        <div class="filter-card" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; border-radius: 8px;">
                            <p style="margin: 0; font-size: 0.95rem;"><i class="bi bi-tag"></i> <strong>$<?php echo e(number_format($minPriceAvailable, 2)); ?></strong> to <strong>$<?php echo e(number_format($maxPriceAvailable, 2)); ?></strong></p>
                        </div>
                    </form>
                </div>
            </div>
            ...
            <div style="flex: 1; min-width: 0;">
                <!-- Results Info -->
                <p style="color: #666; margin-bottom: 1.5rem; font-size: 1rem;"><strong>Showing <?php echo e($products->count()); ?> of <?php echo e($products->total()); ?> products</strong></p>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <div class="product-card">
                            <div class="product-image">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($product->image_path && !empty(trim($product->image_path))): ?>
                            ...
                            <div class="product-info">
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($product->stock > 0): ?>
                                    <span class="badge bg-success stock-badge"><i class="bi bi-check-circle"></i> In Stock • <?php echo e($product->stock); ?></span>
                                <?php else: ?>
